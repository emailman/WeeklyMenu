...
## Main Features
- Weekly Menu: Rolling 7-day view starting from today with full date display (e.g., "Wednesday, Jan 15"), tap to regenerate meal
- Menu Items: CRUD operations, swipe-to-delete, star ratings
- Daily Category: Configure category per day of week (auto-saves on change)
...
- Weekly Menu shows rolling 7-day view starting from today (format: "Wednesday, Jan 15")
...
- Daily Category auto-saves when category is changed (no Save button)
...
1. Changed Weekly Menu from fixed Sunday-Saturday week to rolling 7-day view starting from today
...
5. Daily Category screen now auto-saves (removed Save button and snackbar)
